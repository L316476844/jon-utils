...
public class DateUtils {
    ...
    public static int compareTime(String startTime , String endTime , int type) {
    	...
    	try {
			...
			long between = (end.getTime() - begin.getTime());  //除以1000转换成豪秒
			if(type == 1){   //小时
	 ...
	 * @return
	 */
	public static String formatDate(Date createTime, String format) {
		if (createTime == null) {
			return "";
		}
	 ...
	 * @throws
	 */
	public static String getLastMonthDate(int month){
		Calendar calendar = Calendar.getInstance();
	...
	/**
	 * @Title: getLastMonthFirstDate
	 * @Description: 获取前后月日期月份第一天
	 * @param @param args    设定文件
	 * @return void    返回类型
	 * @throws
	 */
	public  static String getLastMonthFirstDate(int month){
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.MONTH, month);
	...
	/**
	 * @Title: getLastMonthEndDate
	 * @Description: 获取前后月日期月份最后一天
	 * @param @param args    设定文件
	 * @return void    返回类型
	 * @throws
	 */
	public  static String getLastMonthEndDate(int month){
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.MONTH, month);
