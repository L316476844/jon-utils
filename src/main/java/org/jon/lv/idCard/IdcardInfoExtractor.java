...
public class IdcardInfoExtractor {
	...
	// 城市
	private String city; // 未实现
	// 区县
	private String region; // 未实现
	// 年份
	private int year;
	// 月份
	private int month;
	...
	private Map<String, String> cityCodeMap = new HashMap<String, String>() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7293380815380627816L;
	...
	public IdcardInfoExtractor(String idcard) {
		try {
			if (IdcardValidator.isValidatedAllIdcard(idcard)) {
				...
				// 获取省份
				provinceId = idcard.substring(0, 2);
	...
	public static void main(String[] args) {
		String idcard = "4564314316546465";
